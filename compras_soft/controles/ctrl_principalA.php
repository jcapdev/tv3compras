						...
						if($ordenes!=null){
							$hcont = "<h2>Consulta de todas las órdenes en el sistema</h2>
								...
								<table id='hTblOrdenesAprobar' class='zebra'>
									<thead><tr><th style='width:20px;'>Folio</th><th style='width:140px;'>Nombre Trabajador</th><th style='width:100px;'>Departamento</th><th style='width:70px;'>Fecha y hora</th><th style='width:90px;'>Estado</th><th></th></tr></thead>";
									foreach ($ordenes as $row){
										...
										$hcont=$hcont.$row[4]."</td><td style='width:10px;'><button class='btnInfoOrden' id=btnInfoOrden id='btnInfoOrden' value=".$row[0]." style='cursor:pointer'><img src='images/mas.png' title='Información de orden'></td></tr>";
									}
								$hcont=$hcont."</table></div><br />";
							echo $hcont;
						}
